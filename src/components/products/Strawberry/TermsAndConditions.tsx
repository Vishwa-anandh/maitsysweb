...
const TermsAndConditions = () => {
  return (
    <>
      <Seo
        title="Terms & Conditions | SAP IDoc Monitoring | Maitsys"
        description="Terms and conditions for using the Maitsys SAP IDoc Monitoring product."
        url="/products/sap-idoc-monitoring/TermsAndConditions"
      />
